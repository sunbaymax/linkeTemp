<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    ...
    ?></td>
    <td valign="top">
  <?php echo form_open('member/bjSMSSend') ?>
    <table class="tableBorder" cellpadding="0" cellspacing="0">
        <caption>报警短信下发日志            &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="keyword" name="keyword" value="标签编号" size="20" onblur="search(0)" onfocus="search(1)" /><input type="submit" value="查询" name="submit" /></caption>
        <thead>
          <th>ID</th>
          <th>主机编号</th>
		  <th>主机别名</th>
        ...
        <tr bgcolor="#E6EEF7" onMouseOver="this.style.backgroundColor='#CADBF1'" onMouseOut="this.style.backgroundColor='#E6EEF7'">
          ...
          <td align="center"><?php echo $row->sendGSMState;?></td>
          <td align="center"><?php echo $row->sendGSMPhone;?></td>
          <td align="center"><?php echo $row->sendGSMText;?></td>
        </tr>
        <?php endforeach;?>
    <?php endif;?>
    <tr bgcolor="#E6EEF7" onMouseOver="this.style.backgroundColor='#CADBF1'" onMouseOut="this.style.backgroundColor='#E6EEF7'">
