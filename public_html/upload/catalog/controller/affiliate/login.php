...
class ControllerAffiliateLogin extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && isset($this->request->post['email']) && isset($this->request->post['password'])&& isset($this->request->post['code']) && $this->validate()) {
			// Add to activity log
	...
	protected function validate() {
		...
		if (!$this->error) {
		    if (!$this->affiliate->login($this->request->post['code'])) {
		        $this->error['warning'] = $this->language->get('error_loginCode');
		    }
		}
